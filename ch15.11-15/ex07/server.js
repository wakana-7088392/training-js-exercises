...
function cspMiddleware(_url, req, res) {
    const helloHash = "sha256-dEw5ICxbzlNhltZ9i6iwop7945EMiRE7yLYSnQnfnI8="
    const inlineScriptHash = "sha256-ZGKMbT3NegX077yZeKmChVXljdKkjnessl0/j4RVvtA="
    // TODO: CSP ヘッダを設定する
    res.setHeader("Content-Security-Policy", `script-src '${helloHash}' '${inlineScriptHash}'`);
    return true;
}
