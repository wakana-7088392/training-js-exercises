        ...
        case ">": // RedirCmd
            {
                ...
                const file = fs.createWriteStream(cmd.file);
                await runcmd(cmd.cmd, null, file);
        ...
        case "<": // RedirCmd
            {
                ...
                const file = fs.createReadStream(cmd.file);
                await runcmd(cmd.cmd, file, null);
            }
            break;
        ...
        case "|": // PipeCmd
            {
                ...
                await Promise.all([runcmd(cmd.left, null, passThrough), runcmd(cmd.right, passThrough, null)]);
            }
            break;
